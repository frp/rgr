...
{
    return SyntaxNodeList { make_shared<ProgramTNode>(), make_shared<VarNode>(), make_shared<DeclarationListNode>(), make_shared<BeginNode>(), make_shared<OperatorListNode>(), make_shared<EndWithDotNode>() };
}
...
SyntaxNodeList DeclarationListNode::expand()
{
    return SyntaxNodeList { make_shared<DeclarationNode>(), make_shared<DeclarationListTailNode>() };
}

std::set<TokenType> DeclarationListTailNode::acceptedTokens()
{
    return std::set<TokenType> { TokenType::op_separator };
}

SyntaxNodeList DeclarationListTailNode::expand()
{
    return SyntaxNodeList { make_shared<OperatorSepNode>(), make_shared<DeclarationListNode>() };
}
